...
fetchDocs = () => (() => { let json; let req; req = fetch(__Ink_String(`/indexes/docs.json`)); json = bind(req, __Ink_String(`then`))(resp => bind(resp, __Ink_String(`json`))()); return bind(json, __Ink_String(`then`))(index => render((() => {let __ink_assgn_trgt = __as_ink_string(State); __is_ink_string(__ink_assgn_trgt) ? __ink_assgn_trgt.assign(docs, index) : (__ink_assgn_trgt.docs) = index; return __ink_assgn_trgt})())) })();
fetchIndex = () => (() => { let json; let req; req = fetch(__Ink_String(`/indexes/index.json`)); json = bind(req, __Ink_String(`then`))(resp => bind(resp, __Ink_String(`json`))()); return bind(json, __Ink_String(`then`))(index => render((() => {let __ink_assgn_trgt = __as_ink_string(State); __is_ink_string(__ink_assgn_trgt) ? __ink_assgn_trgt.assign(index, index) : (__ink_assgn_trgt.index) = index; return __ink_assgn_trgt})())) })();
